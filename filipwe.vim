...
let palette = {
    ...
    \
    \   'normal':           'guifg=#949494 ctermfg=247',
    \   'comment':          'guifg=#999999 ctermfg=238',
    \   'string':           'guifg=#87af00 ctermfg=106',
    \   'number':           'guifg=#921fbf ctermfg=92',
    \
    \   'def-key-words':    'guifg=#ff4f4f ctermfg=203',
    \   'fn-names' :        'guifg=#5f80e3 ctermfg=32',
    \   'py-key-words' :    'guifg=#ff4f4f ctermfg=203',
    \
    \   'iterations':       'guifg=#f558be ctermfg=165',
...
exec 'hi Statement      '.palette['def-key-words']
exec 'hi Label          '.palette['def-key-words']
...
exec 'hi Special        '.palette['iterations']
